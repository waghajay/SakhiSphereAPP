      ...
      >
        ...
        <View style={styles.profileHeaderCard}>
          ...
          <View style={styles.nameRow}>
            <Text style={styles.userName}>{profile?.name || 'Sakhi Member'}</Text>
            {isVerified && (
        ...
        <TouchableOpacity
          style={[styles.bannerCard, isVerified ? styles.bannerVerified : styles.bannerUnverified]}
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeaderRow}>
            ...
            <TouchableOpacity onPress={() => router.push('/interests' as any)} hitSlop={8}>
        ...
        <View style={styles.menuCard}>
          ...
          >
            <Text style={styles.menuItemIcon}>🔒</Text>
            <Text style={styles.menuItemText}>Privacy & Notification Settings</Text>
            <Text style={styles.menuArrow}>›</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
