...
/** Notifications Screen — Phase 1 placeholder. Phase 4: Real-time notifications. */
export default function NotificationsScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}><Text style={styles.title}>Notifications</Text></View>
      <View style={styles.content}>
        <Text style={styles.placeholder}>Notifications coming in Phase 4 🔔</Text>
        <Text style={styles.sub}>Likes, comments, messages and more.</Text>
      </View>
    </SafeAreaView>
  );
}
