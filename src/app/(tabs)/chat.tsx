...
/** Chat Screen — Phase 1 placeholder. Phase 4: Real-time messaging with Socket.IO. */
export default function ChatScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}><Text style={styles.title}>Messages</Text></View>
      <View style={styles.content}>
        <Text style={styles.placeholder}>Chat coming in Phase 4 💬</Text>
        <Text style={styles.sub}>Real-time messaging with Socket.IO.</Text>
      </View>
    </SafeAreaView>
  );
}
